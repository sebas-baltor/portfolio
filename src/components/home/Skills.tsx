      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 grid-rows-3 gap-4 h-full w-full mt-8 md:grid-cols-3 md:grid-rows-2">
            <Box className="md:col-span-2 " title="JavaScript"  paragraphs={[`Probably my favorite language to work with, the ecosystem is amazing. Most of my learning projects start with this incredible language. I have tested Next.js, Nest.js, React, Astro, and Node.js.`]}/>
