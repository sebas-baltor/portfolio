        ...
        >
          ...
          >
            ...
            <div className="w-full lg:w-1/2">
              <Paragraph className="lg:text-2xl" text={`I'm a Software Engineer with ${new Date().getFullYear() - 2021}+ years of experience, a fan of exploring new technologies and JavaScript.`} />
            </div>
          </div>
